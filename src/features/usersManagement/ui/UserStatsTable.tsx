...
const prepareRows = (stats: StudentCourseStatDto[]) => {
  return stats.map((stat, index) => ({
    id: stat.courseId || index,
    courseTitle: stat.courseTitle || "Без названия",
      ...
      <DataGrid
        ...
        slots={{
          noRowsOverlay: () => (
            ...
            >
              <Typography color="text.secondary">Курсы не назначены</Typography>
            </Box>
          ),
          noResultsOverlay: () => (
            <Box
